...
__author__ = "sadaleo"
__email__ = "dale9292@kettering.edu"


PACKAGE_NAME = "mdfwriter"
INSTALL_REQUIRES = []
DEPENDENCY_LINKS = []
TESTS_REQUIRE = []
LONG_DESCRIPTION = ''
...
class GenerateSphinxDoc(Command):
    ...
    def run(self):
        ...
        os.system('sphinx-apidoc -o docs source -F -H mdfwriter')
...
if __name__ == "__main__":
    ...
    setuptools.setup(
        ...
        description="Generates .mdf data storage files",
        long_description=LONG_DESCRIPTION,

        # The project's main homepage.
        url="https://stash.teslamotors.com/projects/PY/repos/mdfwriter",

        # Author details
        author=__author__,
        author_email=__email__,

        cmdclass={'test': Tox, 'docs': GenerateSphinxDoc},
